...
const myArr = ["Dhoni","Sachin","Virat","Zaheer","Malinga","Shawn"]; //elements inside array    
const myHeors = ["shaktiman", "naagraj"];

console.log( myArr.includes("Kapil")); 
// console.log( myArr.indexOf("Dhoni")); 
...
// const newArr = myArr.join("_");  //change array into string, comma sepearated
